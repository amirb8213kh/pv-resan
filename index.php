...
define('API_KEY','300422768:AAHm7bHPohqsN09rFwIlefXnSkWL53qVuEw');
//----######------
...
🎗 /start 🎗",
	'parse_mode'=>'MarkDown',
        'reply_markup'=>json_encode([
            'inline_keyboard'=>[
                [
                    ['text'=>"ورود به کانال",'url'=>"https://telegram.me/amirb8213"]
                ]
            ]
        ])
    ]));
...
[👆 کلیک برای دیدن آموزش.](https://telegram.me.me/amirb8213/31)
",
		'parse_mode'=>'MarkDown',
        	'reply_markup'=>json_encode([
...
5⃣ وارد ربات ما یعنی @pvsaz_amir8213_bot شوید و سپس دکمه 🔄 ساخت ربات را انتخاب کنید.
